...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    async_add_entities(
        [
            ...
            HipCoordinatorSensor(coordinator, entry.entry_id, "repository_version", "Latest Version"),
            ...
            HipCoordinatorSensor(coordinator, entry.entry_id, "deployment_target", "Deployment Target"),
            HipCoordinatorSensor(coordinator, entry.entry_id, "update_status", "Update Status"),
            HipCoordinatorSensor(coordinator, entry.entry_id, "last_deployment", "Last Deployment"),
            HipCoordinatorSensor(coordinator, entry.entry_id, "last_validation", "Last Validation"),
