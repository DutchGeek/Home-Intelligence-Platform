...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    async_add_entities(
        [
            HipActionButton(coordinator, entry.entry_id, "check_updates", "Check for Updates", coordinator.check_updates),
            ...
            HipActionButton(coordinator, entry.entry_id, "open_release_notes", "Open Release Notes", coordinator.open_release_notes),
